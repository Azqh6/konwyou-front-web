   ...
   <div class="article-item">
    <div class="article-item-inner">
        <div class="article-body">
            <div class="user-info">
                <Avatar :userId="data.userId" :width="30" :height="30"></Avatar>
        ...
        <div class="cover">
           <router-link :to="`/post/${data.articleId}`"><Cover :cover="data.cover" :width="100" v-if="data.cover"></Cover></router-link> 
        </div>
    </div>
   </div>
