<template>
  <div class="edit-post">
    <el-form :model="formData" :rules="rules" ref="formDataRef" class="post-panel" label-width="60px">
        ...
        <el-card>
          ...
          <div class="setting-inner">
            ...
            <el-form-item label="摘要" prop="summary">
              <el-input clearable placeholder="提示信息" v-model="formData.summary" type="textarea" :row="5" :maxlength="200"
...
const markdownHeight = window.innerHeight - 130
const htmlEditorHeight = window.innerHeight - 200
const formData = ref({});
...
const rules = {
  ...
  integral:[{required:true,message:"请输入下载所需的积分"},{validator:proxy.Verify.number,message:'积分只能是数字'}]
};
const api = {
